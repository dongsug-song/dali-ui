...
protected:
  ...
  WebView(const Dali::String& locale, const Dali::String& timezoneId);
...
public:
  ...
  /**
   * @copydoc Dali::Ui::WebView::New( const Dali::String&, const Dali::String& )
   */
  static Ui::WebView New(const Dali::String& locale, const Dali::String& timezoneId);
