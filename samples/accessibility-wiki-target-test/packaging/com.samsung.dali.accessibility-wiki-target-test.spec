Name:       com.samsung.dali.accessibility-wiki-target-test
Summary:    DALi UI Accessibility wiki real-target API test sample
Version:    2.0.0
Release:    1
...
%description
An interactive real-target sample covering all accessibility APIs documented
in the DALi UI Accessibility wiki, with Korean source comments and test steps.

%prep
%setup -q

%define app_root_dir samples/accessibility-wiki-target-test/
...
%defattr(-,root,root,-)
%{app_exe_dir}/accessibility-wiki-target-test.example
